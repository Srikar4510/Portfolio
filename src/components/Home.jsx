    ...
    <div className='w-screen h-screen relative flex justify-center items-center text-white '>
        <div className='p-8 bg-white bg-opacity-10 backdrop-blur-md rounded-3xl shadow-2xl text-center'>
            ...
            <p className='mt-4 text-lg sm:text-xl'>
                I'm an undergraduate student in Computer Science and Engineering at the Indian Institute of Information Technology, Sricity. 🎓<br/>
                My expertise lies in software development, including full-stack development and testing.<br/>
